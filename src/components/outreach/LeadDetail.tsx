    ...
    <OutreachDialog title={target.name || "New target"} onClose={onClose}>
      ...
      {target.id && (
        <nav
          ...
          className="flex shrink-0 flex-wrap gap-2 border-b border-[var(--border)] px-5 py-2"
        >
      ...
      <div className="min-h-0 space-y-5 overflow-x-hidden overflow-y-auto p-5">
        {error && (
      ...
      <footer className="flex shrink-0 justify-end gap-2 border-t border-[var(--border)] p-4">
