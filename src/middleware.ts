...
// api/agent/* and api/proxe/* are machine endpoints — they carry their own
...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|favicon\\.ico|login|api/login|api/arc/sync|api/agent|api/proxe|.*\\.(?:png|jpg|jpeg|svg|ico|webp|woff2?)$).*)",
  ],
};
