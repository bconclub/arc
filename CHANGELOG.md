...
- Replacements were chosen by context rather than swapped blindly. A dash joining two clauses became a full stop where the next word began a sentence and a comma otherwise; a dash introducing a phrase was dropped; the standalone dash meaning "no value" became a plain hyphen; en dashes in numeric ranges such as "0-7 days" became hyphens.
- Checked afterwards for the artefacts a blind replace would leave behind: doubled commas and stray full stops. None found. Build and typecheck clean.
